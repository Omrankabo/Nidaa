...
import { getVolunteers, updateVolunteerStatus, deleteVolunteer, getRequests } from '@/lib/firebase/firestore';
...
export default function VolunteersPage() {
    ...
    const sendNotification = (id: string) => {
        ...
        alert(`تم إرسال إشعار إلى المتطوع ${id}`);
    };
                                    ...
                                    <TableCell className="text-left">
                                        <DropdownMenu>
                                            ...
                                            <DropdownMenuContent align="end">
                                                <DropdownMenuItem onClick={() => sendNotification(volunteer.id)}>
